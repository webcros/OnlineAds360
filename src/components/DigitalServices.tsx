...
const digitalServices = [
  {
    ...
    description: 'Strategy, execution, reporting — in one place. Get a dedicated team that handles everything for you.',
    points: [
  ...
  },
  {
    ...
    description: 'Content creation, community management, influencer outreach, and brand awareness. Build an engaged audience.',
    points: [
  ...
  },
  {
    ...
    description: 'Custom, conversion-optimized websites with mobile-first design, speed optimization, and UX focus.',
    points: [
  ...
  },
  {
    ...
    description: 'Logos, video, and assets that stand out. We build visual identities that resonate with your target audience.',
    points: [
      'Logo & brand identity',
  ...
  },
  {
    ...
    description: 'Automated email flows, newsletters, segmentation, and A/B testing. Turn your email list into a revenue machine.',
    points: [
  ...
  return (
    <section id="services" className="py-24 bg-white">
      <div className="container mx-auto px-4 lg:px-12">
        <div className="mb-16">
          <h2 className="text-[36px] font-bold text-[#111827] mb-4">Digital Services</h2>
          <p className="text-[18px] text-[#4B5563]">Build a powerful online presence that converts</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {digitalServices.map((service, index) => (
            <div key={index} className="flex flex-col bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all overflow-hidden group">
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <ul className="mt-auto space-y-3">
                  {service.points.map((point, pIndex) => (
                    <li key={pIndex} className="flex items-start gap-2 text-[14px] text-[#374151]">
